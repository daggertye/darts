...
fh = logging.FileHandler(os.path.join('attacked_results_test', args.model + '_' + str(args.eps) + '_' + str(args.niters) + '_' + str(args.adv_rate) + '.txt'))
...
train_data = dset.CIFAR10(root='../data', train=False, download=True, transform=train_transform)
